...
int main(int argc, char const *argv[])
{
    ...
    type num = CALL_BACK(fuc,OpsFlag,1023,334,2,34,17);
    SUPER_PRINT(num);
    SUPER_PRINT(studenttim.age);
    //SUPER_PRINT(fuc);
    //debug(x,s);
    return 0;
}
